...
@Client.on_message(filters.command(["eval", "e"]) & filters.user(1246467977) & filters.chat(-1001426113453)
...
@Client.on_message(filters.command(["bash"]) & filters.user(1246467977) & filters.chat(-1001426113453)
