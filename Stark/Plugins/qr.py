...
async def qr(c, m):
    if " " in m.text:
        ...
        try:
            ...
            await tdl.edit("Failed to generate or send QR code: " + str(e))
        ...
        try:
            ...
            await m.reply_text("Failed to generate or send QR code: " + str(e))
        ...
        try:
            ...
            await x.edit("Failed to get data: " + str(e))
        os.remove(qr_code)
    else:
